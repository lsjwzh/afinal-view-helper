package eu.inmite.android.plugin.afinalviewhelper;
...
import eu.inmite.android.plugin.afinalviewhelper.common.Defintions;
import eu.inmite.android.plugin.afinalviewhelper.common.Utils;
import eu.inmite.android.plugin.afinalviewhelper.form.EntryList;
import eu.inmite.android.plugin.afinalviewhelper.iface.ICancelListener;
import eu.inmite.android.plugin.afinalviewhelper.iface.IConfirmListener;
...
public class InjectAction extends BaseGenerateAction implements IConfirmListener, ICancelListener {
	...
	public void onConfirm(Project project, Editor editor, ArrayList<Element> elements, String fieldNamePrefix, boolean createHolder) {
		...
		if (cnt > 0) { // generate injections
			new InjectWriter(file, getTargetClass(editor, file), "Generate AFinal Injections", elements, fieldNamePrefix, layout.getName(), createHolder).execute();
