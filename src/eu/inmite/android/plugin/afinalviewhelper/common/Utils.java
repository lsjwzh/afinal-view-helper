package eu.inmite.android.plugin.afinalviewhelper.common;
...
public class Utils {
	...
	private static final Pattern sInjectionIDPattern = Pattern.compile("^@ViewInject\\(([^\\)]+)\\)$", Pattern.CASE_INSENSITIVE);
